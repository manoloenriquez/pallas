...
export default function About() {
  return (
    <>
      <div className="hidden md:block p-4 snap-y snap-mandatory overflow-y-scroll h-screen">
        <section className="p-8 h-screen snap-center max-w-screen-2xl mx-auto">
        ...
        <section className="flex flex-col md:grid grid-cols-2 items-stretch h-screen snap-center max-w-screen-2xl mx-auto">
          <div className="relative min-h-96">
            <Image
      ...
      <div className="md:hidden p-4 snap-y snap-mandatory overflow-y-scroll h-screen">
        <section className="p-8 h-screen snap-center max-w-screen-2xl mx-auto">
          <Heading>About Us</Heading>
